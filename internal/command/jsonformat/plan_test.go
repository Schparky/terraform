...
Terraform will perform the following actions:
  ...
  # test_resource.after will be imported
...
Terraform will perform the following actions:
  ...
  # test_resource.after will be imported and then updated in-place
  # (moved from test_resource.before)
  ~ resource "test_resource" "after" {
        id    = "1D5F5E9E-F2E5-401B-9ED5-692A215AC67E"
...
Terraform will perform the following actions:
  ...
  # test_resource.resource must be replaced after importing
