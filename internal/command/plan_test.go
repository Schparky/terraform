...
func TestPlan_targeted(t *testing.T) {
	...
	if got, want := output.Stdout(), "3 to add, 0 to import, 0 to change, 0 to destroy"; !strings.Contains(got, want) {
...
func TestPlan_replace(t *testing.T) {
	...
	if got, want := stdout, "1 to add, 0 to import, 0 to change, 1 to destroy"; !strings.Contains(got, want) {
